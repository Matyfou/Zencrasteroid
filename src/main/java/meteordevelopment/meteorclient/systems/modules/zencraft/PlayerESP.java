...
public class PlayerESP extends Module {
    ...
    //private final Set<EntityType<?>> entities = (Set<EntityType<?>>) EntityType.PLAYER;
    ...
    public PlayerESP() {
        super(Categories.Zencraft, "player-ESP", "Renders players through walls.");
    }
    ...
    public Color getColor(Entity entity) {
        if (!(EntityType.PLAYER == (entity.getType()))) return null;
